...
let originalData = localStorage.getItem('userProfile5') ? JSON.parse(localStorage.getItem('userProfile5')) : []
...
function deleteInfo(index){
    if(confirm("Are you sure want to delete?")){
        ...
        localStorage.setItem("userProfile5", JSON.stringify(originalData));
...
filterData.addEventListener("input", ()=> {
    ...
    if(searchTerm !== ""){
        ...
        getData = JSON.parse(localStorage.getItem('userProfile5')) || []
    }
