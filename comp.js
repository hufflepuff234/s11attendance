...
let originalData = localStorage.getItem('userProfile4') ? JSON.parse(localStorage.getItem('userProfile4')) : []
...
function deleteInfo(index){
    if(confirm("Are you sure want to delete?")){
        ...
        localStorage.setItem("userProfile4", JSON.stringify(originalData));
...
filterData.addEventListener("input", ()=> {
    ...
    if(searchTerm !== ""){
        ...
        getData = JSON.parse(localStorage.getItem('userProfile4')) || []
    }
