...
let originalData = localStorage.getItem('userProfile3') ? JSON.parse(localStorage.getItem('userProfile3')) : []
...
function deleteInfo(index){
    if(confirm("Are you sure want to delete?")){
        ...
        localStorage.setItem("userProfile3", JSON.stringify(originalData));
...
filterData.addEventListener("input", ()=> {
    ...
    if(searchTerm !== ""){
        ...
        getData = JSON.parse(localStorage.getItem('userProfile3')) || []
    }
