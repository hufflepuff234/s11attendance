...
let originalData = localStorage.getItem('userProfile6') ? JSON.parse(localStorage.getItem('userProfile6')) : []
...
function deleteInfo(index){
    if(confirm("Are you sure want to delete?")){
        ...
        localStorage.setItem("userProfile6", JSON.stringify(originalData));
...
filterData.addEventListener("input", ()=> {
    ...
    if(searchTerm !== ""){
        ...
        getData = JSON.parse(localStorage.getItem('userProfile6')) || []
    }
