...
let originalData = localStorage.getItem('userProfile7') ? JSON.parse(localStorage.getItem('userProfile7')) : []
...
function deleteInfo(index){
    if(confirm("Are you sure want to delete?")){
        ...
        localStorage.setItem("userProfile7", JSON.stringify(originalData));
...
filterData.addEventListener("input", ()=> {
    ...
    if(searchTerm !== ""){
        ...
        getData = JSON.parse(localStorage.getItem('userProfile7')) || []
    }
